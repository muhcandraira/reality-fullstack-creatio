namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalculateRealityAveragePriceProcessMethodsWrapper

	/// <exclude/>
	public class UsrCalculateRealityAveragePriceProcessMethodsWrapper : ProcessModel
	{

		public UsrCalculateRealityAveragePriceProcessMethodsWrapper(Process process)
			: base(process) {
