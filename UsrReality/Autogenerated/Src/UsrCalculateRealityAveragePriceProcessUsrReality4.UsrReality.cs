namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalculateRealityAveragePriceProcessUsrReality4MethodsWrapper

	/// <exclude/>
	public class UsrCalculateRealityAveragePriceProcessUsrReality4MethodsWrapper : ProcessModel
	{

		public UsrCalculateRealityAveragePriceProcessUsrReality4MethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			...
			var typeFilter = esq.CreateFilterWithParameters(FilterComparisonType.Equal, "UsrRealityType", typeId);
