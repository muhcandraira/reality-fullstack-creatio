namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalculateRealityAveragePriceProcessUsrReality1MethodsWrapper

	/// <exclude/>
	public class UsrCalculateRealityAveragePriceProcessUsrReality1MethodsWrapper : ProcessModel
	{

		public UsrCalculateRealityAveragePriceProcessUsrReality1MethodsWrapper(Process process)
			: base(process) {
