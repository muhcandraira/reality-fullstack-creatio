namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalculateRealityAveragePriceProcessUsrReality2MethodsWrapper

	/// <exclude/>
	public class UsrCalculateRealityAveragePriceProcessUsrReality2MethodsWrapper : ProcessModel
	{

		public UsrCalculateRealityAveragePriceProcessUsrReality2MethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			...
			var typeFilter = esq.CreateFilterWithParameters(FilterComparisonType.Equal, "UsrRealtyType", typeId);
