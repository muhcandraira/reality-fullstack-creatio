namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalculateRealityAveragePriceProcessUsrReality3MethodsWrapper

	/// <exclude/>
	public class UsrCalculateRealityAveragePriceProcessUsrReality3MethodsWrapper : ProcessModel
	{

		public UsrCalculateRealityAveragePriceProcessUsrReality3MethodsWrapper(Process process)
			: base(process) {
